...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        <h1 class="page-title mb-1"><i class="fas fa-plus-circle me-2"></i>Nouveau Produit</h1>
        <p class="text-muted mb-0">Ajouter un médicament au catalogue national</p>
    </div>
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="form-card mb-4">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <label class="form-label">DCI — Dénomination Commune Internationale <span class="required-star">*</span></label>
                        <input type="text" name="dci" class="form-control @error('dci') is-invalid @enderror"
                            placeholder="Ex: Amoxicilline" value="{{ old('dci') }}">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="nom_commercial" class="form-control @error('nom_commercial') is-invalid @enderror"
                            placeholder="Ex: Amoxil" value="{{ old('nom_commercial') }}">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4">
                        ...
                        <select name="forme_galenique" class="form-select @error('forme_galenique') is-invalid @enderror">
                            ...
                            <option value="{{ $forme }}" {{ old('forme_galenique') == $forme ? 'selected' : '' }}>{{ $forme }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="dosage" class="form-control @error('dosage') is-invalid @enderror"
                            placeholder="Ex: 500mg" value="{{ old('dosage') }}">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="code_produit" class="form-control @error('code_produit') is-invalid @enderror"
                            placeholder="Ex: AMOX500CPR" value="{{ old('code_produit') }}">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="code_barre" class="form-control @error('code_barre') is-invalid @enderror"
                            placeholder="Ex: 1234567890123" value="{{ old('code_barre') }}">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" name="prix_vente_recommande" class="form-control @error('prix_vente_recommande') is-invalid @enderror"
                            placeholder="Ex: 15000" value="{{ old('prix_vente_recommande') }}" min="0">
            ...
            <div class="form-card mb-4">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12 col-md-6">
                        <label class="maladie-item {{ in_array($maladie->id, old('maladies', [])) ? 'selected' : '' }}"
                            onclick="this.classList.toggle('selected')">
                            <input type="checkbox" name="maladies[]" value="{{ $maladie->id }}"
                                {{ in_array($maladie->id, old('maladies', [])) ? 'checked' : '' }}>
            ...
            <div class="form-card">
                ...
                <textarea name="description" class="form-control" rows="4"
                    placeholder="Description ou informations supplémentaires sur ce produit...">{{ old('description') }}</textarea>
            </div>
                ...
                <div style="background: #FFFBEB; border: 1px solid #FCD34D; border-radius: 10px; padding: 16px; margin-bottom: 16px;">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="necessite_ordonnance"
                            ...
                            {{ old('necessite_ordonnance') ? 'checked' : '' }}>
                        <label class="form-check-label fw-semibold" for="necessite_ordonnance">
                            Nécessite une ordonnance
                        </label>
                    </div>
                    <p class="text-muted mt-2 mb-0" style="font-size: 12px;">
                        Si activé, ce médicament ne pourra être vendu qu'avec une ordonnance médicale valide.
                    </p>
                </div>
            </div>
