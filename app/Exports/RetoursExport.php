...
class LotsExpiresExport implements FromCollection, WithHeadings, WithStyles, WithTitle
{
    ...
    public function collection()
    {
        ...
        return Lot::with(['produit', 'pharmacie'])
            ...
            ->map(fn($l) => [
                ...
                'Jours Restants'   => now()->diffInDays($l->date_expiration, false),
    ...
    {
        return [1 => ['font' => ['bold' => true, 'color' => ['rgb' => 'FFFFFF']], 'fill' => ['fillType' => 'solid', 'startColor' => ['rgb' => 'DC2626']]]];
    }

    public function title(): string { return 'Lots Expirés'; }
}